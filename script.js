...
function setActiveNavigation() {
    ...
    // If nav items are intentionally commented out (no links present), exit gracefully
    ...
    const fallbackNav = `
        <nav class="navbar">
            <div class="nav-container">
                <div class="nav-brand">
                    <a href="index.html" class="brand-link" data-page="home">
                ...
                <div class="nav-links">
                    ...
                    <a href="career.html" class="nav-link" data-page="career">Career</a>
                    <a href="testimonials.html" class="nav-link" data-page="testimonials">Testimonials</a>
                    <a href="index.html#work" class="nav-link" data-page="work">Let's Work Together</a>
                </div>
            ...
            <div class="mobile-menu">
                ...
                <a href="career.html" class="mobile-nav-link" data-page="career">Career</a>
                <a href="testimonials.html" class="mobile-nav-link" data-page="testimonials">Testimonials</a>
                <a href="index.html#work" class="mobile-nav-link" data-page="work">Let's Work Together</a>
            </div>
        </nav>
    `;
